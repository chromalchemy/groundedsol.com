...
{{
var G__14298 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14298;
continue;
}
} else
...
{var pred__14302 = cljs.core._EQ_;var expr__14303 = limit;if(cljs.core.truth_(pred__14302.call(null,1,expr__14303)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14302.call(null,2,expr__14303)))
...
var G__14305 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14306 = (limit__$1 - 1);
var G__14307 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14305;
limit__$1 = G__14306;
parts = G__14307;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14309 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14309))
{var replacement_14310 = temp__4090__auto___14309;buffer.append([cljs.core.str(replacement_14310)].join(''));
} else
{buffer.append(ch);
}
{
var G__14311 = (index + 1);
index = G__14311;
continue;
}
}
