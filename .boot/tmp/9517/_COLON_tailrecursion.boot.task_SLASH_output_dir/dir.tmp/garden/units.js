...
*/
garden.units.convert = (function convert(p__203948,right){var map__203950 = p__203948;var map__203950__$1 = ((cljs.core.seq_QMARK_.call(null,map__203950))?cljs.core.apply.call(null,cljs.core.hash_map,map__203950):map__203950);var m = cljs.core.get.call(null,map__203950__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));var left = cljs.core.get.call(null,map__203950__$1,new cljs.core.Keyword(null,"unit","unit",1017498870));if(cljs.core.every_QMARK_.call(null,garden.units.convertable_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [left,right], null)))
...
{var vec__203952 = temp__4092__auto__;var _ = cljs.core.nth.call(null,vec__203952,0,null);var magnitude = cljs.core.nth.call(null,vec__203952,1,null);var unit = cljs.core.nth.call(null,vec__203952,2,null);var unit__$1 = cljs.core.keyword.call(null,unit);var magnitude__$1 = (cljs.core.truth_(magnitude)?cljs.reader.read_string.call(null,magnitude):0);return (new garden.types.CSSUnit(unit__$1,magnitude__$1));
} else
{return null;
}
});
...
{var or__201496__auto__ = (function (){var and__201484__auto__ = cljs.core._EQ_.call(null,unit.call(null,x),unit);if(and__201484__auto__)
{return x;
} else
...
var u_PLUS___2 = (function (x,y){var map__203959 = u.call(null,x);var map__203959__$1 = ((cljs.core.seq_QMARK_.call(null,map__203959))?cljs.core.apply.call(null,cljs.core.hash_map,map__203959):map__203959);var m1 = cljs.core.get.call(null,map__203959__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));var map__203960 = u.call(null,y);var map__203960__$1 = ((cljs.core.seq_QMARK_.call(null,map__203960))?cljs.core.apply.call(null,cljs.core.hash_map,map__203960):map__203960);var m2 = cljs.core.get.call(null,map__203960__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));return u.call(null,(m1 + m2));
});
var u_PLUS___3 = (function() { 
var G__203961__delegate = function (x,y,more){return cljs.core.reduce.call(null,u_PLUS_,u_PLUS_.call(null,x,y),more);
};
var G__203961 = function (x,y,var_args){
var more = null;if (arguments.length > 2) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__203961__delegate.call(this,x,y,more);};
G__203961.cljs$lang$maxFixedArity = 2;
G__203961.cljs$lang$applyTo = (function (arglist__203962){
var x = cljs.core.first(arglist__203962);
arglist__203962 = cljs.core.next(arglist__203962);
var y = cljs.core.first(arglist__203962);
var more = cljs.core.rest(arglist__203962);
return G__203961__delegate(x,y,more);
});
G__203961.cljs$core$IFn$_invoke$arity$variadic = G__203961__delegate;
return G__203961;
})()
;
...
var u___2 = (function (x,y){var map__203969 = u.call(null,x);var map__203969__$1 = ((cljs.core.seq_QMARK_.call(null,map__203969))?cljs.core.apply.call(null,cljs.core.hash_map,map__203969):map__203969);var m1 = cljs.core.get.call(null,map__203969__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));var map__203970 = u.call(null,y);var map__203970__$1 = ((cljs.core.seq_QMARK_.call(null,map__203970))?cljs.core.apply.call(null,cljs.core.hash_map,map__203970):map__203970);var m2 = cljs.core.get.call(null,map__203970__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));return u.call(null,(m1 - m2));
});
var u___3 = (function() { 
var G__203971__delegate = function (x,y,more){return cljs.core.reduce.call(null,u_,u_.call(null,x,y),more);
};
var G__203971 = function (x,y,var_args){
var more = null;if (arguments.length > 2) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__203971__delegate.call(this,x,y,more);};
G__203971.cljs$lang$maxFixedArity = 2;
G__203971.cljs$lang$applyTo = (function (arglist__203972){
var x = cljs.core.first(arglist__203972);
arglist__203972 = cljs.core.next(arglist__203972);
var y = cljs.core.first(arglist__203972);
var more = cljs.core.rest(arglist__203972);
return G__203971__delegate(x,y,more);
});
G__203971.cljs$core$IFn$_invoke$arity$variadic = G__203971__delegate;
return G__203971;
})()
;
...
var u_STAR___2 = (function (x,y){var map__203979 = u.call(null,x);var map__203979__$1 = ((cljs.core.seq_QMARK_.call(null,map__203979))?cljs.core.apply.call(null,cljs.core.hash_map,map__203979):map__203979);var m1 = cljs.core.get.call(null,map__203979__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));var map__203980 = u.call(null,y);var map__203980__$1 = ((cljs.core.seq_QMARK_.call(null,map__203980))?cljs.core.apply.call(null,cljs.core.hash_map,map__203980):map__203980);var m2 = cljs.core.get.call(null,map__203980__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));return u.call(null,(m1 * m2));
});
var u_STAR___3 = (function() { 
var G__203981__delegate = function (x,y,more){return cljs.core.reduce.call(null,u_STAR_,u_STAR_.call(null,x,y),more);
};
var G__203981 = function (x,y,var_args){
var more = null;if (arguments.length > 2) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__203981__delegate.call(this,x,y,more);};
G__203981.cljs$lang$maxFixedArity = 2;
G__203981.cljs$lang$applyTo = (function (arglist__203982){
var x = cljs.core.first(arglist__203982);
arglist__203982 = cljs.core.next(arglist__203982);
var y = cljs.core.first(arglist__203982);
var more = cljs.core.rest(arglist__203982);
return G__203981__delegate(x,y,more);
});
G__203981.cljs$core$IFn$_invoke$arity$variadic = G__203981__delegate;
return G__203981;
})()
;
...
var ud__2 = (function (x,y){var map__203989 = u.call(null,x);var map__203989__$1 = ((cljs.core.seq_QMARK_.call(null,map__203989))?cljs.core.apply.call(null,cljs.core.hash_map,map__203989):map__203989);var m1 = cljs.core.get.call(null,map__203989__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));var map__203990 = u.call(null,y);var map__203990__$1 = ((cljs.core.seq_QMARK_.call(null,map__203990))?cljs.core.apply.call(null,cljs.core.hash_map,map__203990):map__203990);var m2 = cljs.core.get.call(null,map__203990__$1,new cljs.core.Keyword(null,"magnitude","magnitude",3292087682));return u.call(null,(m1 / m2));
});
var ud__3 = (function() { 
var G__203991__delegate = function (x,y,more){return cljs.core.reduce.call(null,ud,ud.call(null,x,y),more);
};
var G__203991 = function (x,y,var_args){
var more = null;if (arguments.length > 2) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__203991__delegate.call(this,x,y,more);};
G__203991.cljs$lang$maxFixedArity = 2;
G__203991.cljs$lang$applyTo = (function (arglist__203992){
var x = cljs.core.first(arglist__203992);
arglist__203992 = cljs.core.next(arglist__203992);
var y = cljs.core.first(arglist__203992);
var more = cljs.core.rest(arglist__203992);
return G__203991__delegate(x,y,more);
});
G__203991.cljs$core$IFn$_invoke$arity$variadic = G__203991__delegate;
return G__203991;
})()
;
