...
var G__14450 = null;
var G__14450__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__14450__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
...
;
jQuery.prototype.apply = (function (self__,args14449){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args14449)));
});
...
jQuery.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this$,k){var this$__$1 = this;var or__9585__auto__ = this$__$1.slice(k,(k + 1));if(cljs.core.truth_(or__9585__auto__))
...
var hide__delegate = function ($elem,p__14451){var vec__14453 = p__14451;var speed = cljs.core.nth.call(null,vec__14453,0,null);var on_finish = cljs.core.nth.call(null,vec__14453,1,null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__14451 = null;if (arguments.length > 1) {
  p__14451 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__14451);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__14454){
var $elem = cljs.core.first(arglist__14454);
var p__14451 = cljs.core.rest(arglist__14454);
return hide__delegate($elem,p__14451);
});
...
var show__delegate = function ($elem,p__14455){var vec__14457 = p__14455;var speed = cljs.core.nth.call(null,vec__14457,0,null);var on_finish = cljs.core.nth.call(null,vec__14457,1,null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__14455 = null;if (arguments.length > 1) {
  p__14455 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__14455);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__14458){
var $elem = cljs.core.first(arglist__14458);
var p__14455 = cljs.core.rest(arglist__14458);
return show__delegate($elem,p__14455);
});
...
var toggle__delegate = function ($elem,p__14459){var vec__14461 = p__14459;var speed = cljs.core.nth.call(null,vec__14461,0,null);var on_finish = cljs.core.nth.call(null,vec__14461,1,null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__14459 = null;if (arguments.length > 1) {
  p__14459 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__14459);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__14462){
var $elem = cljs.core.first(arglist__14462);
var p__14459 = cljs.core.rest(arglist__14462);
return toggle__delegate($elem,p__14459);
});
...
var fade_out__delegate = function ($elem,p__14463){var vec__14465 = p__14463;var speed = cljs.core.nth.call(null,vec__14465,0,null);var on_finish = cljs.core.nth.call(null,vec__14465,1,null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__14463 = null;if (arguments.length > 1) {
  p__14463 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__14463);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__14466){
var $elem = cljs.core.first(arglist__14466);
var p__14463 = cljs.core.rest(arglist__14466);
return fade_out__delegate($elem,p__14463);
});
...
var fade_in__delegate = function ($elem,p__14467){var vec__14469 = p__14467;var speed = cljs.core.nth.call(null,vec__14469,0,null);var on_finish = cljs.core.nth.call(null,vec__14469,1,null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__14467 = null;if (arguments.length > 1) {
  p__14467 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__14467);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__14470){
var $elem = cljs.core.first(arglist__14470);
var p__14467 = cljs.core.rest(arglist__14470);
return fade_in__delegate($elem,p__14467);
});
...
var slide_up__delegate = function ($elem,p__14471){var vec__14473 = p__14471;var speed = cljs.core.nth.call(null,vec__14473,0,null);var on_finish = cljs.core.nth.call(null,vec__14473,1,null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__14471 = null;if (arguments.length > 1) {
  p__14471 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__14471);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__14474){
var $elem = cljs.core.first(arglist__14474);
var p__14471 = cljs.core.rest(arglist__14474);
return slide_up__delegate($elem,p__14471);
});
...
var slide_down__delegate = function ($elem,p__14475){var vec__14477 = p__14475;var speed = cljs.core.nth.call(null,vec__14477,0,null);var on_finish = cljs.core.nth.call(null,vec__14477,1,null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__14475 = null;if (arguments.length > 1) {
  p__14475 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__14475);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__14478){
var $elem = cljs.core.first(arglist__14478);
var p__14475 = cljs.core.rest(arglist__14478);
return slide_down__delegate($elem,p__14475);
});
...
var closest__delegate = function ($elem,selector,p__14479){var vec__14481 = p__14479;var context = cljs.core.nth.call(null,vec__14481,0,null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__14479 = null;if (arguments.length > 2) {
  p__14479 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__14479);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__14482){
var $elem = cljs.core.first(arglist__14482);
arglist__14482 = cljs.core.next(arglist__14482);
var selector = cljs.core.first(arglist__14482);
var p__14479 = cljs.core.rest(arglist__14482);
return closest__delegate($elem,selector,p__14479);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__14485){var map__14487 = p__14485;var map__14487__$1 = ((cljs.core.seq_QMARK_.call(null,map__14487))?cljs.core.apply.call(null,cljs.core.hash_map,map__14487):map__14487);var request = map__14487__$1;var contentType = cljs.core.get.call(null,map__14487__$1,new cljs.core.Keyword(null,"contentType","contentType",624772805));var data = cljs.core.get.call(null,map__14487__$1,new cljs.core.Keyword(null,"data","data",1016980252));var ct = jayq.core.__GT_content_type.call(null,contentType);return (function (p1__14484_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__14484_SHARP_,new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.pr_str.call(null,data));
} else
{return p1__14484_SHARP_;
}
}).call(null,(function (p1__14483_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__14483_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",624772805),ct);
} else
{return p1__14483_SHARP_;
}
}).call(null,request));
});
...
var unbind__delegate = function ($elem,ev,p__14491){var vec__14493 = p__14491;var func = cljs.core.nth.call(null,vec__14493,0,null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__14491 = null;if (arguments.length > 2) {
  p__14491 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__14491);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__14494){
var $elem = cljs.core.first(arglist__14494);
arglist__14494 = cljs.core.next(arglist__14494);
var ev = cljs.core.first(arglist__14494);
var p__14491 = cljs.core.rest(arglist__14494);
return unbind__delegate($elem,ev,p__14491);
});
...
var on__delegate = function ($elem,events,p__14495){var vec__14497 = p__14495;var sel = cljs.core.nth.call(null,vec__14497,0,null);var data = cljs.core.nth.call(null,vec__14497,1,null);var handler = cljs.core.nth.call(null,vec__14497,2,null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__14495 = null;if (arguments.length > 2) {
  p__14495 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__14495);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__14498){
var $elem = cljs.core.first(arglist__14498);
arglist__14498 = cljs.core.next(arglist__14498);
var events = cljs.core.first(arglist__14498);
var p__14495 = cljs.core.rest(arglist__14498);
return on__delegate($elem,events,p__14495);
});
...
var one__delegate = function ($elem,events,p__14499){var vec__14501 = p__14499;var sel = cljs.core.nth.call(null,vec__14501,0,null);var data = cljs.core.nth.call(null,vec__14501,1,null);var handler = cljs.core.nth.call(null,vec__14501,2,null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__14499 = null;if (arguments.length > 2) {
  p__14499 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__14499);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__14502){
var $elem = cljs.core.first(arglist__14502);
arglist__14502 = cljs.core.next(arglist__14502);
var events = cljs.core.first(arglist__14502);
var p__14499 = cljs.core.rest(arglist__14502);
return one__delegate($elem,events,p__14499);
});
...
var off__delegate = function ($elem,events,p__14503){var vec__14505 = p__14503;var sel = cljs.core.nth.call(null,vec__14505,0,null);var handler = cljs.core.nth.call(null,vec__14505,1,null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__14503 = null;if (arguments.length > 2) {
  p__14503 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__14503);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__14506){
var $elem = cljs.core.first(arglist__14506);
arglist__14506 = cljs.core.next(arglist__14506);
var events = cljs.core.first(arglist__14506);
var p__14503 = cljs.core.rest(arglist__14506);
return off__delegate($elem,events,p__14503);
});
...
done.cljs$lang$applyTo = (function (arglist__14507){
var deferred = cljs.core.first(arglist__14507);
var fns_args = cljs.core.rest(arglist__14507);
...
fail.cljs$lang$applyTo = (function (arglist__14508){
var deferred = cljs.core.first(arglist__14508);
var fns_args = cljs.core.rest(arglist__14508);
...
always.cljs$lang$applyTo = (function (arglist__14509){
var deferred = cljs.core.first(arglist__14509);
var fns_args = cljs.core.rest(arglist__14509);
