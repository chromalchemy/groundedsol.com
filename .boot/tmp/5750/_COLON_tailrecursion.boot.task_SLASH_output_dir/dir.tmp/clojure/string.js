...
{{
var G__14158 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14158;
continue;
}
} else
...
{var pred__14162 = cljs.core._EQ_;var expr__14163 = limit;if(cljs.core.truth_(pred__14162.call(null,1,expr__14163)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14162.call(null,2,expr__14163)))
...
var G__14165 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14166 = (limit__$1 - 1);
var G__14167 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14165;
limit__$1 = G__14166;
parts = G__14167;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14169 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14169))
{var replacement_14170 = temp__4090__auto___14169;buffer.append([cljs.core.str(replacement_14170)].join(''));
} else
{buffer.append(ch);
}
{
var G__14171 = (index + 1);
index = G__14171;
continue;
}
}
